...
public class CarController {
    ...
    public String carInfo3(@RequestParam String make,@RequestParam int year, Model model){//this is optional
    ...
    @RequestMapping("/info/{make}/{year}") //localhost:8080/info/honda/2015 !!!!->this is not optional
